...
exports.HandoverDetectionEngine = void 0;
const ConversationMemory_1 = require("./ConversationMemory");
class HandoverDetectionEngine {
    /**
     * Main detection method - check if conversation should escalate to human
     */
    static detectHandover(message, conversationId, isVIP = false) {
        ...
        // ═══════════════════════════════════════════════════════════════
        const declineCount = ConversationMemory_1.ConversationMemory.getDeclineCount(conversationId);
        if (declineCount >= 3) {
        ...
        // ═══════════════════════════════════════════════════════════════
        const loopCount = ConversationMemory_1.ConversationMemory.getLoopCount(conversationId);
        if (loopCount >= 4) {
        ...
        // ═══════════════════════════════════════════════════════════════
        const contradictionCount = ConversationMemory_1.ConversationMemory.getContradictionCount(conversationId);
     ...
     */
    static isExplicitHumanRequest(normalized) {
        const patterns = [
            'speak to a human',
     ...
     */
    static isFrustrated(normalized) {
        const patterns = [
            'this is ridiculous',
            'this is frustrating',
            'not working',
     ...
     */
    static isComplexRequest(normalized) {
        const patterns = [
            'multiple people',
            'group booking',
            'team booking',
     ...
     */
    static isAbandoning(normalized) {
        const patterns = [
            'never mind',
            'nevermind',
            'forget it',
...
exports.HandoverDetectionEngine = HandoverDetectionEngine;
//# sourceMappingURL=HandoverDetectionEngine.js.map