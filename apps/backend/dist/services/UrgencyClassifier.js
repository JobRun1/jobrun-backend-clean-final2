...
exports.UrgencyClassifier = void 0;
class UrgencyClassifier {
    ...
    static getUrgencyLevel(text) {
        ...
        // Low urgency
        if (normalized.includes('whenever') ||
...
exports.UrgencyClassifier = UrgencyClassifier;
