...
router.get("/client-overview", authenticate, async (req: any, res) => {
  try {
    const clientId = req.user.clientId;
    const range = (req.query.range as string) || "all"; // day, week, month, year, all
...
// ADMIN VERSION
router.get("/admin-overview", authenticate, async (req: any, res) => {
  try {
